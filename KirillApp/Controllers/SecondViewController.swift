...
class SecondViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        conditionLabel.topAnchor.constraint(equalTo: namedLabel.topAnchor, constant: 30.0).isActive = true
        ...
        conditionLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 50.0).isActive = true
        ...
        tempYesterdayLabel.topAnchor.constraint(equalTo: namedLabel.topAnchor, constant: 60.0).isActive = true
        ...
        tempYesterdayLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 80.0).isActive = true
        tempYesterdayLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        tempTomorrowLabel.topAnchor.constraint(equalTo: namedLabel.topAnchor, constant: 90.0).isActive = true
        ...
        tempTomorrowLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 110).isActive = true
        tempTomorrowLabel.translatesAutoresizingMaskIntoConstraints = false
